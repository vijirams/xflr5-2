 ...
 */
void PanelAnalysis::rotateGeomY(double const &Alpha, CVector const &P, int NXWakePanels)
{
	int n, p, pw, kw, lw;
 ...
 * @param P the point of origin of the rotation
 */
void PanelAnalysis::rotateGeomZ(double const &Beta, CVector const &P, int NXWakePanels)
{
	int n, p, pw, kw, lw;
	int iLA, iLB, iTA, iTB;
	CVector Pt, Trans;
