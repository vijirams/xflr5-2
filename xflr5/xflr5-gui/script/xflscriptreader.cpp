...
bool XFLScriptReader::readScript()
{
	...
	{
		if (!name().compare("XFLR5_SCRIPT", Qt::CaseInsensitive)==0 || attributes().value("version") < "1.0")
		{
	...
	while(!atEnd() && !hasError() && readNextStartElement() )
	{
		...
		else if (name().compare("output", Qt::CaseInsensitive)==0)
		{
			readOutput();
		}
		else if (name().compare("options", Qt::CaseInsensitive)==0)
		{
			readOptions();
		}
		else
...
bool XFLScriptReader::readInput()
{
	...
	{
		//level 2
		if(name().compare("Foils", Qt::CaseInsensitive)==0)
		{
			readFoils();
		}
		else if(name().compare("Foil_Polars", Qt::CaseInsensitive)==0)
		{
			readFoilPolars();
		}
		else if(name().compare("Planes", Qt::CaseInsensitive)==0)
		{
			readPlanes();
		}
		else if(name().compare("Plane_Polars", Qt::CaseInsensitive)==0)
		{
			readPlanePolars();
		}
		else if(name().compare("Foil_Analysis", Qt::CaseInsensitive)==0)
		{
			readFoilAnalysis();
		}
		else if(name().compare("Plane_Analysis", Qt::CaseInsensitive)==0)
		{
			readPlaneAnalysis();
		}
...
bool XFLScriptReader::readOutput()
{
	...
	{
		//level 2
		if(name().compare("Output_Directory", Qt::CaseInsensitive)==0)
		{
			m_OutputDirectoryPath = readElementText();
		}
		else if(name().compare("make_xfl_project_file", Qt::CaseInsensitive)==0)
		{
			m_bMakeXfl = stringToBool(readElementText());
		}
		else if(name().compare("project_file_name", Qt::CaseInsensitive)==0)
		{
			m_projectFileName = readElementText();
		}
		else if(name().compare("make_oppoints", Qt::CaseInsensitive)==0)
		{
...
bool XFLScriptReader::readOptions()
{
	...
	{
		//level 2
		if(name().compare("use_multithreading", Qt::CaseInsensitive)==0)
		{
			m_bMultiThreading = stringToBool(readElementText());
		}
		else if(name().compare("max_threads", Qt::CaseInsensitive)==0)
		{
...
bool XFLScriptReader::readFoils()
{
	while(!atEnd() && !hasError() && readNextStartElement() )
	{
		if (name().compare("Input_Directory_Foil_Files", Qt::CaseInsensitive)==0)
		{
			m_InputFoilDirectoryPath = readElementText();
		}
		else if (name().compare("Foil_Files", Qt::CaseInsensitive)==0)
		{
			while(!atEnd() && !hasError() && readNextStartElement() )
			{
				if (name().compare("Foil_File_Name", Qt::CaseInsensitive)==0)
				{
...
bool XFLScriptReader::readFoilPolars()
{
	while(!atEnd() && !hasError() && readNextStartElement() )
	{
		if (name().compare("Input_Directory_Foil_Polar_Files", Qt::CaseInsensitive)==0)
		{
			m_InputPolarDirectoryPath = readElementText();
		}
		else if (name().compare("Foil_Polar_Files", Qt::CaseInsensitive)==0)
		{
			while(!atEnd() && !hasError() && readNextStartElement() )
			{
				if (name().compare("Polar_File_Name", Qt::CaseInsensitive)==0)
				{
...
bool XFLScriptReader::readPlanes()
{
	while(!atEnd() && !hasError() && readNextStartElement() )
	{
		if (name().compare("Input_Directory_Plane_Files", Qt::CaseInsensitive)==0)
		{
			m_InputPlaneDirectoryPath = readElementText();
		}
		else if (name().compare("Plane_Files", Qt::CaseInsensitive)==0)
		{
			while(!atEnd() && !hasError() && readNextStartElement() )
			{
				if (name().compare("Plane_File_Name", Qt::CaseInsensitive)==0)
				{
...
bool XFLScriptReader::readPlanePolars()
{
	while(!atEnd() && !hasError() && readNextStartElement() )
	{
		if (name().compare("Input_Directory_Plane_Polar_Files", Qt::CaseInsensitive)==0)
		{
			m_InputWPolarDirectoryPath = readElementText();
		}
		else if (name().compare("Plane_Polar_Files", Qt::CaseInsensitive)==0)
		{
			while(!atEnd() && !hasError() && readNextStartElement() )
			{
				if (name().compare("Polar_File_Name", Qt::CaseInsensitive)==0)
...
bool XFLScriptReader::readPlaneAnalysis()
{
	while(!atEnd() && !hasError() && readNextStartElement() )
	{
		if(name().compare("Alpha", Qt::CaseInsensitive)==0)
		{
		...
		else if(name().compare("Beta", Qt::CaseInsensitive)==0)
		{
		...
		else if(name().compare("Velocity", Qt::CaseInsensitive)==0)
		{
		...
		else if(name().compare("Control", Qt::CaseInsensitive)==0)
		{
...
bool XFLScriptReader::readFoilAnalysis()
{
	while(!atEnd() && !hasError() && readNextStartElement() )
	{
		...
		else if(name().compare("Forced_Top_Transition", Qt::CaseInsensitive)==0)
		{
			m_XtrTop = readElementText().toDouble();
		}
		else if(name().compare("Forced_Bottom_Transition", Qt::CaseInsensitive)==0)
		{
			m_XtrBot = readElementText().toDouble();
		}
		else if(name().compare("Reynolds", Qt::CaseInsensitive)==0)
		{
		...
		else if(name().compare("NCrit", Qt::CaseInsensitive)==0)
		{
		...
		else if(name().compare("Mach", Qt::CaseInsensitive)==0)
		{
