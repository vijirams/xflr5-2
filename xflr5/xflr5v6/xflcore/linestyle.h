...
struct LineStyle
{
    ...
    LineStyle(bool bVisible, Line::enumLineStipple style, int width, QColor const &color,  Line::enumPointStyle pointstyle=Line::NOSYMBOL, QString LineTag=QString(), bool bEnabled=true)
    {
