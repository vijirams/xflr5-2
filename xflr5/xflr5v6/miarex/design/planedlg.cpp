...
{
    m_plePlaneName->setText(m_pPlane->planeName());
...
void PlaneDlg::onDefineWing()
{
    ...
    wingDlg.setTexturePath(m_TexturePath);
...
void PlaneDlg::onDefineBody()
{
    ...
    glbDlg.setTexturePath(m_TexturePath);
...
{
    m_pPlane->setPlaneName(m_plePlaneName->text());
}
...
void PlaneDlg::setParams()
{
    ...
    m_pchDoubleFin->setChecked(m_pPlane->m_bDoubleFin);
    m_pchSymFin->setChecked(m_pPlane->m_bSymFin);
    onFin();
