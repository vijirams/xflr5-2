...
void BatchDlg::setupLayout()
{
    ...
    QVBoxLayout *pRightSideLayout = new QVBoxLayout;
    {
        ...
        m_pctrlGraphOutput = new GraphWt;
...
void BatchDlg::initDialog()
{
    ...
    if(m_PolarType!=Xfl::FIXEDAOAPOLAR)
    {
        ...
        m_pctrlReDelta->setDigits(0);

        m_pctrlSpecMin->setDigits(3);
        m_pctrlSpecMax->setDigits(3);
        m_pctrlSpecDelta->setDigits(3);
    ...
    {
        m_pctrlReMin->setDigits(1);
        m_pctrlReMax->setDigits(1);
        m_pctrlReDelta->setDigits(1);

        m_pctrlSpecMin->setDigits(0);
        m_pctrlSpecMax->setDigits(0);
        m_pctrlSpecDelta->setDigits(0);
...
void BatchDlg::onPolarType()
{
    ...
    {
        m_pctrlReMin->setDigits(2);
        m_pctrlReMax->setDigits(2);
        m_pctrlReDelta->setDigits(2);
        m_pctrlSpecMin->setDigits(0);
        m_pctrlSpecMax->setDigits(0);
        m_pctrlSpecDelta->setDigits(0);
...
void BatchDlg::onFoilList()
{
    ...
    if(m_pFoil) dlg.setFoilName(m_pFoil->name());
...
void BatchDlg::outputFoilList()
{
    ...
    {
        if(m_pFoil)
            m_pctrlTextOutput->append("   "+m_pFoil->name());
    }
    else
    {
