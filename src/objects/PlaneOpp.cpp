...
QString PlaneOpp::title()
{
	...
	if(m_WPolarType==XFLR5::STABILITYPOLAR) str5 = QString("_Ctrl=%1").arg(m_Ctrl,5,'f',2);
	else                             str5 ="";


	if(m_AnalysisMethod==XFLR5::LLTMETHOD)  str6="_LLT";
	else if(m_bThinSurface)
	{
		if(m_bVLM1) str6="_VLM1";
		else        str6="_VLM2";
	}
	else if(m_AnalysisMethod==XFLR5::PANELMETHOD)
	{
		str6="_Panel";
